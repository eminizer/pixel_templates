...
struct SiPixelTemplateEntry2D { //!< Basic template entry corresponding to a single set of track angles
   ...
   float scalex;           //!< x-error scale factor
   float scaley;           //!< y-error scale factor
   float spare[16];
} ;
...
public:
   ...
   float scaley() {return scaley_;}                                  //!< y-reco error scaling factor
   float scalex() {return scalex_;}                                  //!< x-reco error scaling factor
...
private:
   ...
   float scalex_;            //!< x-error scale factor
   float scaley_;            //!< y-error scale factor
