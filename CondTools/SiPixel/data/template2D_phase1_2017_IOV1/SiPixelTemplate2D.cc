//
//  SiPixelTemplate2D.cc  Version 2.00
//
   ...
   if(in_file.is_open()) {
      ...
      for (iy=0; iy < theCurrentTemp.head.NTyx; ++iy) {
         for(jx=0; jx < theCurrentTemp.head.NTxx; ++jx) {
            ...
            in_file >> theCurrentTemp.entry[iy][jx].clsleny >> theCurrentTemp.entry[iy][jx].clslenx >> theCurrentTemp.entry[iy][jx].spare[0] >> theCurrentTemp.entry[iy][jx].spare[1]
            >> theCurrentTemp.entry[iy][jx].spare[2] >> theCurrentTemp.entry[iy][jx].scalex >> theCurrentTemp.entry[iy][jx].scaley >> theCurrentTemp.entry[iy][jx].spare[3] >> theCurrentTemp.entry[iy][jx].spare[4] >> theCurrentTemp.entry[iy][jx].spare[5];
            ...
            in_file >> theCurrentTemp.entry[iy][jx].spare[6] >> theCurrentTemp.entry[iy][jx].spare[7] >> theCurrentTemp.entry[iy][jx].spare[8] >> theCurrentTemp.entry[iy][jx].spare[9]
            >> theCurrentTemp.entry[iy][jx].spare[10] >> theCurrentTemp.entry[iy][jx].spare[11] >> theCurrentTemp.entry[iy][jx].spare[12] >> theCurrentTemp.entry[iy][jx].spare[13]
            >> theCurrentTemp.entry[iy][jx].spare[14]  >> theCurrentTemp.entry[iy][jx].spare[15];
   ...
   for(int m=0; m<db.numOfTempl(); ++m)
   {
      ...
      for (iy=0; iy < theCurrentTemp.head.NTyx; ++iy) {
         for(jx=0; jx < theCurrentTemp.head.NTxx; ++jx) {
            ...
            db >> theCurrentTemp.entry[iy][jx].clsleny >> theCurrentTemp.entry[iy][jx].clslenx >> theCurrentTemp.entry[iy][jx].spare[0] >> theCurrentTemp.entry[iy][jx].spare[1]
            >> theCurrentTemp.entry[iy][jx].spare[2] >> theCurrentTemp.entry[iy][jx].scalex >> theCurrentTemp.entry[iy][jx].scaley >> theCurrentTemp.entry[iy][jx].spare[3] >> theCurrentTemp.entry[iy][jx].spare[4] >> theCurrentTemp.entry[iy][jx].spare[5];
            ...
            db >> theCurrentTemp.entry[iy][jx].spare[6] >> theCurrentTemp.entry[iy][jx].spare[7] >> theCurrentTemp.entry[iy][jx].spare[8] >> theCurrentTemp.entry[iy][jx].spare[9]
            >> theCurrentTemp.entry[iy][jx].spare[10] >> theCurrentTemp.entry[iy][jx].spare[11] >> theCurrentTemp.entry[iy][jx].spare[12] >> theCurrentTemp.entry[iy][jx].spare[13]
            >> theCurrentTemp.entry[iy][jx].spare[14]  >> theCurrentTemp.entry[iy][jx].spare[15];
...
bool SiPixelTemplate2D::interpolate(int id, float cotalpha, float cotbeta, float locBz, float locBx)
{
   ...
   scaley_ = thePixelTemp_[index_id_].entry[iy0_][jx0_].scaley
   +adcota_*(thePixelTemp_[index_id_].entry[iy0_][jx1_].scaley - thePixelTemp_[index_id_].entry[iy0_][jx0_].scaley)
   +adcotb_*(thePixelTemp_[index_id_].entry[iy1_][jx0_].scaley - thePixelTemp_[index_id_].entry[iy0_][jx0_].scaley);
   
   scalex_ = thePixelTemp_[index_id_].entry[iy0_][jx0_].scalex
   +adcota_*(thePixelTemp_[index_id_].entry[iy0_][jx1_].scalex - thePixelTemp_[index_id_].entry[iy0_][jx0_].scalex)
   +adcotb_*(thePixelTemp_[index_id_].entry[iy1_][jx0_].scalex - thePixelTemp_[index_id_].entry[iy0_][jx0_].scalex);
...
// Interpolate for a new set of track angles
   ...
   if(SiPixelTemplate2D::interpolate(id, cotalpha, cotbeta, locBz, locBx)) {
      ...
      return SiPixelTemplate2D::xytemp(xhit, yhit, yd, xd, template2d, derivatives, dpdx2d);
   } else {
      return false;
   }
